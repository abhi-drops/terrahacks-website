            ...
            <footer className="bg-[#0B0507] text-white py-12">
                <div className="main flex flex-col items-center justify-center space-y-6">
                    ...
                    <div className="flex flex-col lg:flex-row items-center justify-center space-y-4 lg:space-x-12">
                        <a name='Link to MLH Code of Conduct' rel='noopener noreferrer' href="/assets/mlh-conduct.pdf" target="_blank" className="md:text-lg lg:text-xl xl:text-2xl hover:text-gray-300 ease-in-out duration-300 underline">MLH Code of Conduct</a>
                        <a name='Link to Sponsorship Package (Coming Soon)' rel='noopener noreferrer' href="#" target="_blank" className="md:text-lg lg:text-xl xl:text-2xl hover:text-gray-300 ease-in-out duration-300 underline pointer-events-none">Become a Sponsor (Coming Soon)</a>
                    </div>
