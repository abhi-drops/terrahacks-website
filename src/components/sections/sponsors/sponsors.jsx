                            ...
                            return (
                                ...
                                >
                                    <Image
                                        ...
                                        width={500}
                                        height={500}
                                        className={`object-contain w-full h-full pointer-events-none ${sponsor.shortName === 'CS TMU' && 'py-2 rounded-md'} ${sponsor.shortName === 'Armed Forces' && 'px-2 py-1 rounded-md'} ${sponsor.shortName === 'FoS' && 'px-2 rounded-md'}`}
                                    />
                                </button>
                            );
                        }
