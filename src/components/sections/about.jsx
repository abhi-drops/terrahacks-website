    ...
    return (
        <>
            <div id="about" ref={contentRef} className="flex flex-col justify-center items-center absolute top-[13.6%] md:top-[13.8%] lg:top-[18.3%] 2xl:top-[17.7%] pl-[51%] pr-[8%] lg:pl-[35%] lg:pr-[23%] 2xl:pl-[39%] 2xl:pr-[27%] mx-auto w-full h-[9%] lg:h-[8%] float-in-section">
                ...
                <p
                    className={`hidden md:block pt-2 md:pt-4 lg:pt-8 2xl:pt-12 text-xs md:text-sm xl:text-base 3xl:text-lg text-[#FAFAFA]`}
                >
                ...
                <p
                    className={`pt-4 md:pt-4 lg:pt-8 2xl:pt-12 text-xs md:text-sm xl:text-base 3xl:text-lg text-[#FAFAFA]`}
                >
            ...
            <div className="absolute w-[25%] md:w-[20%] 2xl:w-[15%] left-[77%] md:left-[80%] lg:left-[72%] 2xl:left-[67%] top-[11.8%] md:top-[12%] lg:top-[16.3%] 2xl:top-[15.5%]">
                <Image
                    src="/assets/moles/teacher_mole.png"
                    alt="TerraHacks Logo"
                    width={1500}
                    height={1500}
                    priority={true}
